...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/AccountProfileScreen` | `/AccountSignupScreen` | `/AppearanceTheme` | `/AuthContext` | `/FitnessSurveyScreen` | `/HomeScreen` | `/LogoutScreen` | `/PostWorkoutScreen` | `/PrivacyPolicy` | `/ProtectedRoute` | `/ResetPasswordScreen` | `/ResetUserNameScreen` | `/SettingsScreen` | `/_sitemap` | `/editUsernameScreen` | `/loginScreen` | `/modal` | `/navigation`;
