...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/(tabs)\ResetUserNameScreen` | `/AccountProfileScreen` | `/AccountSignupScreen` | `/AppearanceTheme` | `/AuthContext` | `/FitnessSurveyScreen` | `/HomeScreen` | `/LogoutScreen` | `/PrivacyPolicy` | `/ProtectedRoute` | `/ResetPasswordScreen` | `/ResetUserNameScreen` | `/SettingsScreen` | `/_sitemap` | `/editUsernameScreen` | `/loginScreen` | `/modal` | `/navigation`;
