...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/AccountProfileScreen` | `/AccountSignupScreen` | `/AppearanceTheme` | `/AuthContext` | `/AvatarStorage` | `/DailyWorkoutScreen` | `/FitnessSurveyScreen` | `/HomeScreen` | `/LogoutScreen` | `/PostWorkoutScreen` | `/PrivacyPolicy` | `/ProtectedRoute` | `/ResetPasswordScreen` | `/ResetUserNameScreen` | `/SettingsScreen` | `/_sitemap` | `/loginScreen` | `/modal` | `/navigation`;
