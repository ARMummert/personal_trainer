...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/AccountProfileScreen` | `/AccountSignupScreen` | `/AppearanceTheme` | `/FitnessSurveyScreen` | `/HomeScreen` | `/LogoutScreen` | `/PrivacyPolicy` | `/ResetPasswordScreen` | `/ResetUserNameScreen` | `/SettingsScreen` | `/_sitemap` | `/loginScreen` | `/modal` | `/navigation`;
