...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/(tabs)\editUsernameScreen` | `/AccountProfileScreen` | `/AccountSignupScreen` | `/AppearanceTheme` | `/AuthContext` | `/DailyWorkoutScreen` | `/FitnessSurveyScreen` | `/HomeScreen` | `/LogoutScreen` | `/PostWorkoutScreen` | `/PrivacyPolicy` | `/ProtectedRoute` | `/ResetPasswordScreen` | `/ResetUserNameScreen` | `/SettingsScreen` | `/_sitemap` | `/editUsernameScreen` | `/loginScreen` | `/modal` | `/navigation`;
