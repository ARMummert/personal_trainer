...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/AccountProfileScreen` | `/AccountSignupScreen` | `/AppearanceTheme` | `/FitnessSurveyScreen` | `/HomeScreen` | `/LogoutScreen` | `/PrivacyPolicy` | `/ResetPasswordScreen` | `/ResetUserNameScreen` | `/SettingsScreen` | `/_sitemap` | `/editAccountProfileScreen` | `/loginScreen` | `/modal` | `/navigation`;
